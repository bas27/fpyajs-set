# Домашнее задание к лекции «Контейнеры» [![Build status](https://ci.appveyor.com/api/projects/status/9aheop5wj1valu22?svg=true)](https://ci.appveyor.com/project/bas27/fpyajs-set)
